...
function nimbus_field_engine() {
    ...
    foreach ($options as $option) {
        ...
        if ($option['type'] == "text") {
            ...
            $section_return[$option['tab']] .= '<p><span style="color:#fc7e2a; font-weight:bold;">' . $join_text . '</span> <a style="font-weight:bold;" href="http://www.nimbusthemes.com/join/?utm_source=' . THEME_SLUG . '&utm_medium=theme&utm_content=panel_link&utm_campaign=' . THEME_SLUG . '">' . $join_link_text . '</a></p>';
            $field_num++;    
